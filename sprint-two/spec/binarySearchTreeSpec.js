describe('binarySearchTree', function () {
  ...
  it('should execute a callback on every value in a tree using "breadthFirstLog" and do it in breadth first order', function () {
    var array = [];
    var func = function (value) { array.push(value); };
    binarySearchTree.insert(3);
    binarySearchTree.insert(10);
    ...
    expect(array).to.eql([5, 3, 10, 1, 4, 14, 3.5, 4.5, 13]);
  });
